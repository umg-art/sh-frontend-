    ...
    <>
      <section className="image-library">
        <div className="container">
          ...
          <main className="main mt-5" id="thermal_catalog">
            <section id="thermal_catalog">
              <div className="title mb-3">
          ...
          <main className="main mt-5" id="dsm_dtm_catalog">
            <section id="dsm_dtm_catalog">
              <div className="title mb-3">
